  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 print:py-4 print:px-8">
        {/* Cabeçalho do plano */}
        <div className="bg-blue-900 text-white p-6 rounded-2xl mb-6 print:rounded-none">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-3xl">🎓</span>
            <span className="text-lg font-semibold opacity-80">Planeprof</span>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <div className="flex flex-wrap gap-2">
              {plano.habilidades_bncc?.map((h, i) => (
                <span key={i} className="bg-blue-50 text-blue-700 border border-blue-200 px-3 py-1 rounded-full text-sm font-mono">
                  {h}
                </span>
              ))}
            </div>
