...
const CONTEUDOS_PROGRAMATICOS: Record<string, Record<string, Record<string, string[]>>> = {
  ...
  'Inglês': {
    ...
    '9º Ano': {
      ...
      '4': ['Final English portfolio of Fundamental Education','Language passport: self-assessment','Complete review of Fundamental Education English','Preparation for High School','Plans for continuing English learning'],
    },
  },
}
